                        ...
                        <hr />
                            ...
                            <div class="row features text-center mb-5">
                                 <?php 
                                    ...
                                    $sql1 = "select * from catagories WHERE category_status = :status";
                                    $stmt = $pdo->prepare($sql1);
                                    $stmt->execute([ ':status' => 'Published' ]);


                                    while($catagories = $stmt->fetch(PDO::FETCH_ASSOC)){
                                        $category_title = $catagories['category_name'];
                                        $category_total_post = $catagories['category_total_post']; ?>
                                    ...
                                    <a class="card card-link border-top border-top-lg border-primary h-100 lift" href="#!"
                                        ...
                                        <div class="card-footer bg-transparent pt-0 pb-5"><div class="badge badge-pill badge-light font-weight-normal px-3 py-2"><?php echo $category_total_post; ?> Posts</div></div></a>
                                </div>
